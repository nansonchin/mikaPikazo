                ...
                <div className='flex-8 flex h-screen overflow-hidden bg-[#CFFE48] relative '>
                    ...
                    <div className='flex-1 m-auto px-10 z-20'>
                        ...
                        <div className="text-lg text-black my-3">
                            {resetSuccess ? '3秒後にホームページに戻ります' : '新しいパスワードを再度入力してください'}
                            ...
                            (
                                <>
                                    <div className=" w-full py-5 flex flex-col relative">
                                        ...
                                        <input type={showResetPass ? 'text' : 'password'} className='w-full border-b-2 border-b-solid font-bold' />
                                        <span className="">
                                    ...
                                    <div className=" w-full py-5 flex flex-col relative">
                                        ...
                                        <input type={showReset2Pass ? 'text' : 'password'} className='w-full border-b-2 border-b-solid font-bold' />
                                        <span className="">
